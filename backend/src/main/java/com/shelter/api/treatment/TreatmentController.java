...
public class TreatmentController {
 private final TreatmentRepository treatments; private final AnimalRepository animals;
 public TreatmentController(TreatmentRepository treatments,AnimalRepository animals){this.treatments=treatments;this.animals=animals;}
